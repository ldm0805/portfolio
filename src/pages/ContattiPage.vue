...
<template lang="">
  <div class="cont d-flex justify-content-center flex-column align-items-center">
    ...
    <button type="button" class="portfolio-link" data-toggle="modal" data-target="#exampleModal">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="portfolio-link" @click="sendMail()"  data-dismiss="modal">Invia dati</button>
      </div>
    </div>
  </div>
</div>
